...
static constexpr auto qt_meta_stringdata_CLASSBossEnemyENDCLASS = QtMocHelpers::stringData(
    "BossEnemy",
    "move",
    ""
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSBossEnemyENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSBossEnemyENDCLASS_t qt_meta_stringdata_CLASSBossEnemyENDCLASS = {
    {
        QT_MOC_LITERAL(0, 9),  // "BossEnemy"
...
void BossEnemy::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BossEnemy *>(_o);
        (void)_t;
        switch (_id) {
