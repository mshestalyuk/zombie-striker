...
#include <QGraphicsScene> // if you need to access the scene
#include <Player.h>
#include <Game.h>
...
BossEnemy::BossEnemy() {
    ...
    // drew the rect
    QPixmap originalPixmap(":/images/images/boss.png");
    QPixmap scaledPixmap = originalPixmap.scaled(125, 125, Qt::KeepAspectRatio);
